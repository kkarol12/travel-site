...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function events() {
      ...
      this.closeModalButton.click(this.closeModal.bind(this)); //bind method pozwala na zachowanie this do tego przycisku a nie przejscie do this w metodzie np openModal

      //pushes the escape keywords
